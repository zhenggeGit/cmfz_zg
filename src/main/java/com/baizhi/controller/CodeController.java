...
public class CodeController {
	...
	private TextRenderer textRenderer = null;
		@RequestMapping("/yzm")
		public void createYzm(HttpServletRequest request,HttpServletResponse response)throws Exception{
			init();
			...
			session.setAttribute("validationCode", validationCode);  //session中存储随机数
			//ValueStack vs = ActionContext.getContext().getValueStack();
			//vs.setValue("#validationCode", validationCode);
