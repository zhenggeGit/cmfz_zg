					...
					<tbody>
					  ...
					  <tr>
						...
						<tr>
							...
							<th>验证码:</th>
							<td>
								<%--class="text captcha  自动大写"--%>
								<input type="text" id="enCode" name="code"  maxlength="4" autocomplete="off" "/>
								<img id="captchaImage" class="captchaImage"  onclick="document.getElementById('captchaImage').src='${pageContext.request.contextPath}/Code/yzm?'+(new Date()).getTime()"
									 src="${pageContext.request.contextPath}/Code/yzm" title="点击更换验证码"/>
							</td>
						</tr>					
					<tr>
						<td>
